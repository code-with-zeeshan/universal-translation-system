...
from training.quantization_pipeline import fake_quantize_tensor
...
from training.hardware_profile import HardwareProfile, find_free_port
...
class IntelligentTrainer(BaseTrainer):
    ...
    def _setup_models(self):
        ...
        if getattr(self.config.training, 'use_lora', False):
            from training.peft_integration import wrap_encoder_with_lora, wrap_decoder_with_lora, print_trainable_parameter_stats
