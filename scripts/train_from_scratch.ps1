...
Write-Host "Full End-to-End Training Pipeline for Universal Translation System"
Write-Host "================================================================"

# 1. Prepare all data
Write-Host "[Step 1/6] Running unified data pipeline..."
python - <<'PY'
...
Write-Host "[Step 2/6] Creating vocabulary packs from processed data..."
python -m vocabulary.vocabulary_creator
...
Write-Host "[Step 3/6] Initializing models from pretrained weights (XLM-R & mBART)..."
...
# 4. Train models
Write-Host "[Step 4/6] Starting main training loop..."
python -m training.launch train --config "$repoRoot\config\base.yaml"
Assert-LastExit "Training launch failed"
Write-Host "[Step 4/6] Training complete."

# 5. Convert models for production
Write-Host "[Step 5/6] Converting trained models to production formats (ONNX, etc.)..."
python -m training.convert_models
Assert-LastExit "Model conversion failed"
Write-Host "[Step 5/6] Model conversion complete."

# 6. Finalize production models
Write-Host "[Step 6/6] Finalizing production models..."
Write-Host "[Step 6/6] Production models are ready."

Write-Host "Full training pipeline finished! Models are ready in 'models/production'."
Write-Host "================================================================"
