...
setup_node() {
    ...
    echo ""
    echo "  universal-decoder-node --help"
    echo "  udn --help"
    echo ""

    echo "=== Starting the node ==="
    echo ""
    echo "  universal-decoder-node start --port 8000"
    echo ""
    echo "  # Or with a config file:"
    echo "  universal-decoder-node init --output config.yaml"
    echo "  universal-decoder-node start --config config.yaml"
    echo ""

    echo "=== Registering with coordinator ==="
    echo ""
    echo "  # Interactive registration:"
    echo "  universal-decoder-node register"
    echo ""
